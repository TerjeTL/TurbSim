function [CUR_SpL] = F_CUR(param,Nc_corr_n)
% [CUR_SpL] = F_CUR(param,Nc_corr_n)
%
% Computes CUR values given the parameters and the normalized corrected speed vector
%
...
%% Extract parameters
c1          = param(1:3);
% Compute the CUR for each SpL
CUR_SpL     = c1(1)+c1(2).*Nc_corr_n.^c1(3);
end